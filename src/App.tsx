...
function LoginPage() {
  ...
  const submit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setNotice({ kind: "error", text: friendly(error) });
    } finally {
      setBusy(false);
    }
  };
