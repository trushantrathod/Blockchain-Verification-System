    ...
    <main className="page auth auth-experience">
      ...
      <section className="auth-card auth-card-large">
        ...
        <div className="auth-switch">
          ...
          <button className="text-button" onClick={() => navigate("/register")}>Create account</button>
        </div>
      </section>
    </main>
  </Shell>;
  ...
  return <Shell>
    <main className="page auth auth-experience register-auth">
      <section className="auth-card auth-card-large">
        ...
        <h2>Create your uploader account</h2>
        <p className="auth-lead">Create an account to issue certificates and manage your verification records.</p>
        ...
        <div className="auth-switch">
          ...
          <button className="text-button" onClick={() => navigate("/login")}>Uploader sign in</button>
        </div>
      </section>
    </main>
  </Shell>;
